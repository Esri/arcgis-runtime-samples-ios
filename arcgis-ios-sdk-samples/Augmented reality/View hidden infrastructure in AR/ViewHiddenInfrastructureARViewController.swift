...
class ViewHiddenInfrastructureARPipePlacer: UIViewController {
    ...
    private func configureMap() {
        ...
        pipesOverlay.renderer = AGSSimpleRenderer(symbol: AGSSimpleLineSymbol(style: .solid, color: .red, width: 2))
...
extension ViewHiddenInfrastructureARPipePlacer {
    ...
    @objc
    func startSketch(_ sender: UIBarButtonItem) {
...
extension HiddenInfrastructureARViewer {
    @objc
    func setRealScaleMode(_ sender: UISegmentedControl) {
