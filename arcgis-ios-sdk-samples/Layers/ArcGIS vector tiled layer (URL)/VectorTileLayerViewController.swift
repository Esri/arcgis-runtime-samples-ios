...
class VectorTileLayerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //newly found vector tile layer Style URL
        let vectorTileLayer = AGSArcGISVectorTiledLayer(url: URL(string: "https://www.arcgis.com/sharing/rest/content/items/4a143b53b7a343aa914167464eb1ab91/resources/styles/root.json")!)
        ...
        mapView.setViewpointCenter(AGSPoint(x: -119.4179, y: 36.7783, spatialReference: .wgs84()), scale: 100000000)
    }
